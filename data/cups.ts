...
export const cupData: Tournament[] = [
    ...
    },
    {
        ...
        logoUrl: 'https://via.placeholder.com/150/8B4513/FFFFFF?text=Hhohho+Qualifiers',
        rounds: []
    },
    {
        id: 'ingwenyama-manzini',
        name: 'Ingwenyama Cup (Manzini Region)',
        logoUrl: 'https://via.placeholder.com/150/8B4513/FFFFFF?text=Manzini+Qualifiers',
        rounds: []
    },
    {
        id: 'ingwenyama-lubombo',
        name: 'Ingwenyama Cup (Lubombo Region)',
        logoUrl: 'https://via.placeholder.com/150/8B4513/FFFFFF?text=Lubombo+Qualifiers',
        rounds: []
    },
    {
        id: 'ingwenyama-shiselweni',
        name: 'Ingwenyama Cup (Shiselweni Region)',
        logoUrl: 'https://via.placeholder.com/150/8B4513/FFFFFF?text=Shiselweni+Qualifiers',
        rounds: []
    },
    {
        ...
        rounds: [
            {
                ...
                matches: [
                    ...
                    { id: 3, team1: { name: 'St. Marks High', score: '2 (4)', crestUrl: 'https://via.placeholder.com/64/14B8A6/FFFFFF?text=SMH' }, team2: { name: 'Sifundzani High', score: '2 (3)', crestUrl: 'https://via.placeholder.com/64/D63031/FFFFFF?text=SHS' }, winner: 'team1', date: '2023-10-11' },
