  ...
  useEffect(() => {
    const loadData = async () => {
        ...
        try {
            ...
            console.error("Failed to load U-19 data", e);
        } finally {
            setLoading(false);
        }
    };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-5xl font-display font-black text-blue-900 mb-4 uppercase tracking-tight">
            U-19 National Football
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            The bridge to senior professional football. Follow elite U-19 tactical development or manage your official regional hub through our digital ecosystem.
          </p>
        </div>

        {/* 1. News Updates & Media */}
        <div className="mb-20 border-t pt-8">
            <h2 className="text-2xl font-display font-black mb-8 border-b pb-4 text-gray-900 uppercase">U-19 Updates & Media</h2>
            {combinedArticles.length > 0 ? (
                ...
                <div className="text-center py-10 bg-white rounded-2xl border border-dashed text-gray-400">
                    No recent news articles found for Under-19 Football.
                </div>
            )}
        </div>
        ...
        <div className="mb-20">
            <RegionalLeagueHub 
                ...
                hubType="U-19 Juniors" 
                description="Manage your regional U-19 division. Centralize match results, track elite player trajectories, and maintain live standings for the final development tier."
            />
        </div>
        ...
        {data?.risingStars && data.risingStars.length > 0 && (
            <section className="border-t pt-16">
                <h2 className="text-3xl font-display font-black mb-8 border-b pb-4 text-gray-900 uppercase">Premier Prospects (U-19)</h2>
