                ...
                <CardContent className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="externalApiId" name="externalApiId" value={formData.externalApiId} onChange={handleChange} className={inputClass} placeholder="e.g., 4328 (from TheSportsDB)" />
                            <p className="text-xs text-gray-500 mt-1">This ID is required for the Live Fixture Import feature.</p>
                        </div>
