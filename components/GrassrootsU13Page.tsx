      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-5xl font-display font-black text-blue-900 mb-4 uppercase tracking-tight">
            U-13 Grassroots National Football
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Cultivating the Kingdom's youngest talents. Manage regional festivals and track national grassroots progress.
          </p>
        </div>

        {/* Create New League CTA */}
        <div className="mb-16 max-w-4xl mx-auto">
            <Card className="bg-gradient-to-br from-green-700 to-green-900 text-white shadow-2xl border-0 overflow-hidden relative group">
                <CardContent className="p-10 text-center md:text-left md:flex items-center justify-between gap-8 relative z-10">
                    <div className="flex-1">
                        <h2 className="text-3xl font-display font-black mb-4 uppercase tracking-tight">Launch a Grassroots League</h2>
                        <p className="text-green-50 mb-6 md:mb-0 leading-relaxed opacity-90">
                            Empower your community. Create a digital space to track Under-13 scores, teams, and standings for your region.
                        </p>
                    </div>
